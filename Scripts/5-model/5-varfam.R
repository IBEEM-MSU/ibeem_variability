...
fit <- rstan::stan(paste0(dir, 'Scripts/Model_files/6-varfam.stan'),
                   data = DATA,
                   chains = CHAINS,
                   iter = ITER,
                   cores = CHAINS,
...
MCMCvis::MCMCdiag(fit, 
                  ...
                  cp_file = c(paste0(dir, 'Scripts/Model_files/6-varfam.stan'), 
                              paste0(dir, 'Scripts/6-varfam.R')),
                  cp_file_names = c(paste0('6-varfam-', run_date, '.stan'),
                                    paste0('6-varfam-', run_date, '.R')))
