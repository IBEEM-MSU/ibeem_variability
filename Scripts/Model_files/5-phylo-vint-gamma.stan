...
// gamma regression
// https://discourse.mc-stan.org/t/gamma-regression-in-stan-vs-frequentist-approach/16274
data {
...
parameters {
  ...
  vector[J] theta; // intercept for niche
  real<lower=0> sigma_theta; // mean thetas
...
transformed parameters {
  ...
  b = a ./ exp(kappa + theta[niche_idx] + alpha + X * beta);
}
model {
  // priors
  beta ~ std_normal();
